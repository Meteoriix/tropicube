...
- mémoire suffisante pour Velocity, MySQL, Redis, le Lobby maintenu au démarrage et les instances de jeu créées à la demande. Prévoir au minimum 8 Gio pour un environnement de test confortable, davantage en production.
