...
During active phases, each kingdom member sees their own heart's current and maximum health in the actionbar, including zero after destruction. Respawn and territory alerts temporarily take priority and are rendered again in the player's current language. Hitting an enemy heart still displays its temporary bossbar independently.
