...
- l'onglet Placeholders inventorie automatiquement tous les placeholders nommés de Core et Velocity, décrit l'information dynamique fournie par chacun, permet de les rechercher et affiche chaque module et clé de traduction qui les utilise ;
