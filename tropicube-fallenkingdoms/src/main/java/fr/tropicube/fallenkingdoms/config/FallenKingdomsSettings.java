...
public record FallenKingdomsSettings(int countdownSeconds, int resultDisplaySeconds, int minPlayersPerKingdom,
    ...
    public static FallenKingdomsSettings load(FileConfiguration config) {
        ...
        return new FallenKingdomsSettings(effectiveCountdown, display, effectiveMin,
                ...
                new WorldCycleSettings(config.getInt("world-cycle.day-duration-seconds"),
                        config.getInt("world-cycle.night-duration-seconds")),
                new SpawnSettings(config.getDouble("spawns.natural-hostile-night-retention")),
                new DropSettings(config.getDouble("drops.flint-base-chance"),
                        config.getDouble("drops.creeper-gunpowder-multiplier")),
